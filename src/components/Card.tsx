...
const Card = (props: PropsType) => {
  ...
  return (
    <div className='w-[100%] md:w-1/3 h-[30%] md:h-[100%] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 m-2'>
      <div
